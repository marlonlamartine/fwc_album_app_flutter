...
class StickersRepositoryImpl implements StickersRepository {
  ...
  Future<List<GroupsStickers>> getMyAlbum() async {
    try {
      ...
      log('Erro ao buscar o album do usuario', error: e, stackTrace: s);
  ...
  Future<void> registerUserSticker(int stickerId, int amount) async {
    try {
      ...
      log('Erro ao inserir figurinha no álbum do usuário',
          error: e, stackTrace: s);
      throw RepositoryException(
          message: 'Erro ao inserir figurinha no álbum do usuário');
    }
  }
